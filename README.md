...
### Please don't clone the repository, get the program from "Releases" https://github.com/dooji2/flash-rpc/releases/
...
3. It is only for Windows, so please download the executable from "Releases".
